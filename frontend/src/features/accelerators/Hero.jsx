  ...
  return (
    <header className="relative w-full">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=2000&q=60')",
          filter: "grayscale(6%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="absolute inset-0 flex items-center">
        <div className="mx-auto max-w-5xl px-6 w-full">
          ...
          >
            Benchmark startups, shortlist with signals, and run programs with data‑driven workflows.
          </p>
          <div className="mt-6">
            <a
              href="#features"
